...
# Function parses JSON data from openweather API for weather information requested
...
# Function provides what the minimum temperature is
def get_temp_min(weather_info):
    return weather_info["main"]["temp_min"]

# Function provides what the maximum temperature is
